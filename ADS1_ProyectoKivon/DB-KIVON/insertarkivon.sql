...
value(null, 1, 1, 'Ismael', 'Jhaziel', 'Sarzuri', 'Rojas', '8333482', 'LP', '1998-08-30', '/fotos_usuarios/1', '77561348', 'jhaziel', '12345', true);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 2, 1, 'Carlos', 'Alberto', 'Ojeda', 'Vargas', '8333483', 'SC', '1997-01-15', '/fotos_usuarios/2', '77316431', 'carlos', '12346', true);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 3, 1, 'Jose Maria', " ", 'Mendoza', 'Mamani', '8333484', 'LP', '1997-02-20', '/fotos_usuarios/3', '71767349', 'josemaria', '12347', false);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 3, 1, 'Luis', " ", 'Montaño', " ", '8333485', 'LP', '1995-02-16', '/fotos_usuarios/4', '77966358', 'luis', '12348', false);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 3, 1, 'Daniel', " ", 'Resoalbe', " ", '8333486', 'CB', '1998-06-30', '/fotos_usuarios/5', '71757468', 'daniel', '12349', false);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 4, 1, 'Yessica', 'Ester', 'Navarro', 'Suarez', '8333423', 'TJ', '1998-07-01', '/fotos_usuarios/6', '71753290', 'yessica', '12350', false);
insert into usuario (idUsuario, idRol, idSucursal, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, CI,lugarExpedicion, fechaNacimiento, fotografia, numeroCelular, login, password, activo)
value(null, 4, 1, 'Dayana', 'Laura', 'Rico', 'Tellez', '83334811', 'CB', '1996-10-27', '/fotos_usuarios/7', '71700359', 'dayana', '12362', false);
...
insert into referenciaUsuario (idReferenciaUsuario, idUsuario, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, numeroCelular, ci, lugarExpedicion, fechaNacimiento, fotografiaCarnet)
value(null, 3, 'Dario', null, 'Resoalbe', null, '71736001', '39485767', 'CB', '1996-09-30', '/fotos_garante/3');
insert into referenciaUsuario (idReferenciaUsuario, idUsuario, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, numeroCelular, ci, lugarExpedicion, fechaNacimiento, fotografiaCarnet)
value(null, 4, 'Lorgio', null, 'Montaño', null, '71736324', '39485768', 'LP', '1996-10-30', '/fotos_garante/4');
insert into referenciaUsuario (idReferenciaUsuario, idUsuario, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, numeroCelular, ci, lugarExpedicion, fechaNacimiento, fotografiaCarnet)
value(null, 5, 'Maria Jose', null, 'Mendoza', 'Mamani', '71736993', '39485769', 'LP', '1996-11-30', '/fotos_garante/5');
insert into referenciaUsuario (idReferenciaUsuario, idUsuario, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, numeroCelular, ci, lugarExpedicion, fechaNacimiento, fotografiaCarnet)
