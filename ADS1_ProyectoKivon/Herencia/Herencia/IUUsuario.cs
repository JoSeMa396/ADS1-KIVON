...
namespace Herencia
{
    public partial class IUUsuario : Form
    {
        ...
        private void VaciarCampos()
        {
            cmbTipoUsuario.Text = "";
            txtLogin.Text = "";
            picBoxFotoUser.ImageLocation = null;
        ...
        {
            txtLogin.Text = CultureInfo.CurrentCulture.TextInfo.ToLower(txtLogin.Text);
            txtPassword.Text = txtLogin.Text;
        }

        private void txtPrimerNombre_TextChanged(object sender, EventArgs e)
        {
            txtPrimerNombre.Text = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(txtPrimerNombre.Text);
        ...
        private void ciNumLetra(KeyPressEventArgs e)
        {
            try
            {
                if (char.IsNumber(e.KeyChar))
