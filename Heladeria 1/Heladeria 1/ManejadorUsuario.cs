    ...
    class ManejadorUsuario
    {
        ...
        public List<Usuario> listaUsuarios()
        {
            ...
            while (drLecturaDeConsulta.Read())
            {
                ...
                objUsuario.login = drLecturaDeConsulta.GetString(11);
                objUsuario.password = drLecturaDeConsulta.GetString(12);
                ...
                //objUsuario.fechaNacimiento = Convert.ToString(drLecturaDeConsulta.GetString(9));
